...
$query_scorers = "SELECT * FROM Scorer NATURAL JOIN Player NATURAL JOIN Matches NATURAL JOIN Venue NATURAL JOIN Contracts NATURAL JOIN TEAM;";
    ...
    if ($total != 0) {
        ...
        while($row = mysqli_fetch_assoc($result_scorers)) {
            echo "<tr>
                ...
                <td><a href='match_scorer_update.php?scorer_id=$row[scorer_id]'><input type ='submit' value= 'Update' class='update'></a>
