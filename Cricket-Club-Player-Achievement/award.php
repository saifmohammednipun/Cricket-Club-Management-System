...
$query_awards = "SELECT * FROM Awards NATURAL JOIN Player NATURAL JOIN  Player_Login NATURAL JOIN Matches NATURAL JOIN Venue NATURAL JOIN Contracts NATURAL JOIN Team where Player_Login.username = '$username'";
